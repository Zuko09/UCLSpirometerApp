...
class ViewController: UIViewController, AVAudioRecorderDelegate, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var playRecordedSoundButton: UIButton!
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // invis play recorded sound button
        playRecordedSoundButton.alpha = 0
        // Configure Picker
    ...
    // Segues to RecordingsViewController
    ...
    @IBAction func playRecordedSoundButtonPressed(_ sender: Any) {
        print("This Button is beint worked on")
...
//        }
    ...
    // Distance Input Field: UIPickerView
    // Required Func. Returns number of columns in pickerView
    func numberOfComponents(in pickerView: UIPickerView) -> Int {
        return 1
    }
    // Required Func. Returns number of rows in pickerView
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return pickerData.count
    }
    // Required Func. Returns title text for each row
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return String(pickerData[row])
    }
    // Called when a new row is selected.
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        currentDistancePick = pickerData[row]
    }

    // Closes Keyboard on touch out side of keyboard
    ...
    //Required Func. Called when recorded finishes recording.
